...
namespace Reference
{
    partial class Label
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.eventText.Location = new System.Drawing.Point(29, 342);
    ...
    "　　　　　= \"LinkLabelをクリックしました\";";
            ...
            this.label14.Size = new System.Drawing.Size(300, 121);
            this.label14.TabIndex = 71;
            this.label14.Text = "Label: ユーザーが直接編集できないテキストを表示します。\r\nLinkLabel :テキストを Web スタイルのリンクとして表示し、ユーザーが特別なテキスト" +
    "をクリックしたときに、イベントをトリガーします。 通常、対象となるテキストは、別のウィンドウや Web サイトへのリンクです。";
            // 
            // label1
            // 
            ...
            this.Name = "Label";
            this.Text = "コモンコントロール/Label,LinkLabel";
